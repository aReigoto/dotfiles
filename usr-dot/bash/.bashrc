...
# This file shoud contain only functions and alias !!!!!!
...
#alias man='/usr/bin/man 2>/dev/null'        # TO REMOVE CHECK IF MACOX SOLVE THE PROBLEM!!!!!!!!!!!!!!!!!!
...
alias vim="vim"
alias vimVanila="vim -u NONE"
alias showEnvVar='( set -o posix ; set ) | cat'   # printenv also works
commandP() { command -V $1  | perl -lane 'print "$F[2]"' ; }
commandD() { dirname $(commandP $1) ; }
commandF() { basename $(commandP $1) ; }
...
alias myip4='dig @resolver1.opendns.com ANY myip.opendns.com +short'	 # myip:         Public facing IP Address
alias myip6='dig @resolver1.opendns.com AAAA myip.opendns.com +short -6' # myip:         Public facing IP Address
alias myLocalIp='ifconfig | grep "inet 192.168*"'						 # myLocalIp
