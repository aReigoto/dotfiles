...
function M.on_attach(client, bufnr)
  ...
  require('lsp-c.keymaps').setup(bufnr)

  -- Configure highlighting
  require("lsp-c.highlighter").setup(client, bufnr)
...
-- Setup LSP handlers
require("lsp-c.handlers").setup()

function M.setup()
  -- null-ls
  require("lsp-c.null-ls").setup(opts)

  -- Installer
  require("lsp-c.installer").setup(servers, opts)
